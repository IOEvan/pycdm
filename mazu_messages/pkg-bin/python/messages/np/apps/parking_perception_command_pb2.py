...
_PARKINGPERCEPTIONCOMMAND_FUSIONMODEREQUEST = _descriptor.EnumDescriptor(
  name='FusionModeRequest',
  full_name='nio.ad.messages.ParkingPerceptionCommand.FusionModeRequest',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PARK_MODE', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DRIVING_MODE', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='DRIVING_MODE_ONE_CLICK', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='RESERVER_MODE2', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_PARKINGPERCEPTIONCOMMAND_FUSIONMODEREQUEST)
...
_PARKINGPERCEPTIONCOMMAND = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='park_memory_request', full_name='nio.ad.messages.ParkingPerceptionCommand.park_memory_request', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fusion_mode_request', full_name='nio.ad.messages.ParkingPerceptionCommand.fusion_mode_request', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='nio.ad.messages.ParkingPerceptionCommand.timestamp', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sensor_original_ts', full_name='nio.ad.messages.ParkingPerceptionCommand.sensor_original_ts', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='publish_ptp_ts', full_name='nio.ad.messages.ParkingPerceptionCommand.publish_ptp_ts', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='publisher_id', full_name='nio.ad.messages.ParkingPerceptionCommand.publisher_id', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='counter', full_name='nio.ad.messages.ParkingPerceptionCommand.counter', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='publish_ts', full_name='nio.ad.messages.ParkingPerceptionCommand.publish_ts', index=14,
  ...
  enum_types=[
    ...
    _PARKINGPERCEPTIONCOMMAND_FUSIONMODEREQUEST,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto2',
...
_PARKINGPERCEPTIONCOMMAND.fields_by_name['fusion_mode_request'].enum_type = _PARKINGPERCEPTIONCOMMAND_FUSIONMODEREQUEST
_PARKINGPERCEPTIONCOMMAND.fields_by_name['sensor_original_ts'].message_type = common_dot_perf_dot_sensor__ts__header__pb2._SENSORTSHEADER
_PARKINGPERCEPTIONCOMMAND_PARKINGPERCEPTIONTYPE.containing_type = _PARKINGPERCEPTIONCOMMAND
_PARKINGPERCEPTIONCOMMAND_FUSIONMODEREQUEST.containing_type = _PARKINGPERCEPTIONCOMMAND
